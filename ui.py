...
"")
        ...
        self.frame.setStyleSheet("background-color: rgb(255, 52, 34)")
        self.frame.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame.setObjectName("frame")
        self.label = QtWidgets.QLabel(self.frame)
        self.label.setGeometry(QtCore.QRect(120, 30, 251, 51))
        font = QtGui.QFont()
...
"")
        ...
        self.label_2.setGeometry(QtCore.QRect(70, 80, 341, 171))
        self.label_2.setText("")
        self.label_2.setPixmap(QtGui.QPixmap("icon1.png"))
...
"color: white;")
        ...
        self.input_amount.setGeometry(QtCore.QRect(50, 350, 380, 60))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(14)
        font.setBold(True)
...
"color: white;")
        ...
        self.output_currency.setGeometry(QtCore.QRect(50, 420, 380, 60))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(14)
        font.setBold(True)
...
"color: white;")
        ...
        self.output_amount.setGeometry(QtCore.QRect(50, 490, 380, 60))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(14)
        font.setBold(True)
...
"color: white;")
        ...
        self.pushButton.setGeometry(QtCore.QRect(50, 570, 380, 60))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(14)
        font.setBold(True)
